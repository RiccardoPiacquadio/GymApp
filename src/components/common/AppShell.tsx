...
const DumbbellIcon = () => (
  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" xmlns="http://www.w3.org/2000/svg">
...
const HistoryIcon = () => (
  <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="min-h-screen bg-app-glow">
      ...
      {location.pathname !== "/profiles" ? (
        <nav className="fixed inset-x-0 bottom-0 border-t border-white/[0.06] bg-[#0a0a0a]/95 px-3 pb-[env(safe-area-inset-bottom,8px)] pt-2 shadow-nav backdrop-blur-xl">
